...
document.getElementById('employee').addEventListener('change', (event) => {
    ...
    const year = document.getElementById('year').value;
    if (employeeId) {
        fetchAbsencesForEmployee(employeeId, month, year); // Charger les absences de l'employé sélectionné
    }
});
...
document.getElementById('showAbsencesButton').addEventListener('click', () => {
    ...
    const year = document.getElementById('year').value;
    if (employeeId) {
        fetchAbsencesForEmployee(employeeId, month, year); // Charger les absences pour l'employé sélectionné
    }
});
